...
namespace H264Sharp
{
    ...
    */
    ...
    const auto y_factor = vdupq_n_s16(75);      // 1.164 * 64
        ...
        int end)
    {
        for (int y = begin; y < end; y += 2) 
        {
            ...
            for (int x = 0; x < width; x += 16) {
                ...
                y_vals_16_1l = vshrq_n_s16(vmulq_s16(y_vals_16_1l, y_factor), 6);
                y_vals_16_1h = vshrq_n_s16(vmulq_s16(y_vals_16_1h, y_factor), 6);
                y_vals_16_2l = vshrq_n_s16(vmulq_s16(y_vals_16_2l, y_factor), 6);
                y_vals_16_2h = vshrq_n_s16(vmulq_s16(y_vals_16_2h, y_factor), 6);
