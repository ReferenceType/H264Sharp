    ...
    inline void RGBToI420_AVX2_(const uint8_t* RESTRICT src, uint8_t* RESTRICT y_plane, int width, int height, int stride, int begin, int end) {
        ...
        for (int y = begin; y < end; y += 2)
        {
            for (int x = 0; x < width; x += 32)
            {
                ...
                {
                    if constexpr (RGB)
                        GetChannels4_16x16_2(src_row1, r0l, g0l, b0l, r0h, g0h, b0h);
                    else
                        GetChannels4_16x16_2(src_row1, b0l, g0l, r0l, b0h, g0h, r0h);
                ...
                {
                    if constexpr (RGB)
                        GetChannels3_16x16_2(src_row1, r0l, g0l, b0l, r0h, g0h, b0h);
                    else
                        GetChannels3_16x16_2(src_row1, b0l, g0l, r0l, b0h, g0h, r0h);
            ...
            for (int x = 0; x < width; x += 32)
            {
                 ...
                 {
                     if constexpr (RGB)
                         GetChannels4_16x16_2(src_row2, r1l, g1l, b1l, r1h, g1h, b1h);
                     else
                         GetChannels4_16x16_2(src_row2, b1l, g1l, r1l, b1h, g1h, r1h);
                 }
                 else
                 {
                     if constexpr (RGB)
                         GetChannels3_16x16_2(src_row2, r1l, g1l, b1l, r1h, g1h, b1h);
                     else
                         GetChannels3_16x16_2(src_row2, b1l, g1l, r1l, b1h, g1h, r1h);
                 ...
                 __m256i packed = _mm256_packus_epi16(y1l, y1h);
                 __m256i y1 = _mm256_permute4x64_epi64(packed, _MM_SHUFFLE(3, 1, 2, 0));
