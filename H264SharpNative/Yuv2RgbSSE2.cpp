...
namespace H264Sharp
{
	...
	template<int NUM_CH, bool RGB>
	void ConvertYUVNV12ToRGB_SSE_Body(const uint8_t* RESTRICT y_plane,const uint8_t* RESTRICT uv_plane,uint8_t* RESTRICT rgb_buffer,int32_t width,
		int32_t Y_stride,int32_t UV_stride,int32_t RGB_stride,int32_t begin,int32_t end);
