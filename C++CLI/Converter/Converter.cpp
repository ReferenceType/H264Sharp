...
extern "C"
void Yuv420P2RGB_(unsigned char* dst_ptr,
...
void BGRAtoYUV420Planar_(unsigned char* bgra, unsigned char* dst, int width, int height, int stride)
{
...
void RGBAtoYUV420Planar_(unsigned char* bgra, unsigned char* dst, int width, int height, int stride)
{
    const int frameSize = width * height;
    int yIndex = 0;
    int vIndex = frameSize;
...
void BGRtoYUV420Planar_(unsigned char* bgra, unsigned char* dst, int width, int height, int stride)
{
    const int frameSize = width * height;
    int yIndex = 0;
    int vIndex = frameSize;
...
void RGBtoYUV420Planar_(unsigned char* bgra, unsigned char* dst, int width, int height, int stride)
{
    const int frameSize = width * height;
    int yIndex = 0;
    int vIndex = frameSize;
